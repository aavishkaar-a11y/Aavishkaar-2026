...
import hauntHuntImg from "@/assets/events/haunt-hunt.jpg";
import connexionsImg from "@/assets/events/connexions.jpg";
import iplAuctionImg from "@/assets/events/ipl-auction.jpg";
import groupDanceImg from "@/assets/events/group-dance.jpg";
import shortFilmImg from "@/assets/events/short-film.jpg";
...
const eventImages: Record<string, string> = {
  ...
  "haunt-hunt": hauntHuntImg,
  connexions: connexionsImg,
  "ipl-auction": iplAuctionImg,
  "group-dance": groupDanceImg,
  "short-film": shortFilmImg,
  esports: esportsImg,
};
    ...
    <Layout>
      ...
      <div className="relative min-h-screen">
        ...
        <video
          ...
          "
        >
          <source src="/videos/day1-bg.mp4" type="video/mp4" />
        </video>
